    ...
    <div className="max-w-6xl mx-auto px-4 py-6 space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <select
          ...
          className="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-gray-400 min-w-[240px]"
        >
      ...
      {!selectedProjectId ? (
        <div className="text-center py-16">
          ...
          <p className="text-sm text-gray-400">Select a project to view change requests</p>
        </div>
      ) : (
        <>
          {/* ===== REQUESTS TAB ===== */}
            ...
            <div className="space-y-4">
              ...
              {workflowsLoading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-sm text-gray-400">No approval workflows defined</p>
                  <p className="text-xs text-gray-400 mt-1">Create a workflow to define approval steps for change requests</p>
                </div>
              ) : (
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="bg-gray-50 border-b border-gray-200">
                        ...
                        <th className="text-left px-4 py-2 font-semibold text-gray-600 text-xs uppercase tracking-wider">Entity Type</th>
                        <th className="text-left px-4 py-2 font-semibold text-gray-600 text-xs uppercase tracking-wider">Steps</th>
                        <th className="text-right px-4 py-2 font-semibold text-gray-600 text-xs uppercase tracking-wider">Actions</th>
                      </tr>
                    </thead>
