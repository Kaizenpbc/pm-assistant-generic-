    ...
    <div className="min-h-screen bg-white dark:bg-gray-800">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-gray max-w-none text-sm text-gray-600 dark:text-gray-300 space-y-6">
          ...
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mt-8">4. Subscription and Billing</h2>
          ...
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mt-8">5. Acceptable Use</h2>
          ...
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mt-8">6. Data and Privacy</h2>
          ...
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mt-8">7. AI-Generated Content</h2>
          ...
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mt-8">8. Limitation of Liability</h2>
          ...
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mt-8">9. Termination</h2>
          ...
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mt-8">10. Changes to Terms</h2>
          <p>We may update these Terms from time to time. Continued use of the Service after changes constitutes acceptance of the new Terms.</p>

          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mt-8">11. Contact</h2>
